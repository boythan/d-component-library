...
var InputText = function (_a) {
    ...
    var renderInput = function () {
        if (multiple) {
            return (React__default.createElement("textarea", { value: value, onChange: onChange, rows: rows, name: name, className: textAreaClass, cols: cols, disabled: disabled }));
        }
        return (React__default.createElement("input", { value: value, onChange: onChange, className: inputClass, name: name, required: true, key: key, placeholder: placeholder, onBlur: onBlur, type: type, disabled: disabled }));
    };
...
var Select = function (_a) {
    ...
    return (React__default.createElement("div", { className: container },
        ...
        React__default.createElement(Select$1, __assign({}, props, { value: value, mode: multiple ? "multiple" : undefined, allowClear: allowClear, placeholder: placeholder, defaultValue: defaultValue, onChange: onChange, className: selectClass, showArrow: true, disabled: disabled, optionFilterProp: "children" }), children),
        error && (React__default.createElement("div", { className: "flex-center-y mt-1" },
            React__default.createElement(Icon$1, { name: "error_outline", className: "text-error", size: "small" }),
            React__default.createElement("text", { className: errorTextClass }, error)))));
};
