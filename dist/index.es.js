...
var Icon = function (_a) {
    ...
    return React.createElement("i", { className: iconClass }, name);
};
...
var InputText = function (_a) {
    ...
    var renderInput = function () {
        if (multiple) {
            return (React.createElement("textarea", { value: value, onChange: onChange, rows: rows, name: name, className: textAreaClass, cols: cols, disabled: disabled }));
        }
        return (React.createElement("input", { value: value, onChange: onChange, className: inputClass, name: name, required: true, key: key, placeholder: placeholder, onBlur: onBlur, type: type, disabled: disabled }));
    };
    return (React.createElement("div", { className: container },
        label && (React.createElement("label", { htmlFor: name, className: labelClass },
            React.createElement("span", null, label))),
        renderInput(),
        error && (React.createElement("div", { className: "flex-center-y mt-1" },
            React.createElement(Icon, { name: "error_outline", className: "text-error", size: "small" }),
            React.createElement("text", { className: errorTextClass }, error)))));
};
